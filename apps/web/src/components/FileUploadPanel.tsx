...
> = {
  examples: {
    label: "Форлаге / примерни ТП",
    icon: "📄",
    accept: ".pdf,.docx,.doc",
    hint: "Форлаге за взаимстване и адаптиране на приложими текстове, описания и методологии; изискванията винаги идват от новата документация",
  },
  tender_docs: {
