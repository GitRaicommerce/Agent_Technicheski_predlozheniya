...
- "deadline": общ/относителен срок (напр. „30 календарни дни за проектиране“).
  Конкретните календарни дати са забранени в ТП и следва да се маркират като
  критичен проблем, а не да се приемат като срок от графика.
...
- SCHEDULE: задачите от линейния график (име, продължителност, зависимости).
  Календарните начални/крайни дати са условни и не са договорни факти.
