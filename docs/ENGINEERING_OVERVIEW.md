...
- Total backend tests discovered: `167`
- `test_agents.py`: `37`
...
- Total script tests discovered: `67`
- `scripts/tests/test_compare_calibration_manifests.py`: `9`
...
- `scripts/tests/test_run_calibration_remediation_cycle.py`: `14`
