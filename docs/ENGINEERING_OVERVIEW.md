...
- Total backend tests discovered: `165`
- `test_agents.py`: `36`
- `test_common_proposal_scenarios.py`: `12`
...
- Total script tests discovered: `63`
...
- `scripts/tests/test_run_calibration_manifest_actions.py`: `17`
