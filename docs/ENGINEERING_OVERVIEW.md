...
- Total backend tests discovered: `176`
- `test_agents.py`: `38`
- `test_common_proposal_scenarios.py`: `14`
- `test_drafting_blueprint.py`: `4`
- `test_export.py`: `11`
- `test_export_readiness_report.py`: `2`
- `test_files.py`: `10`
- `test_generation_jobs.py`: `10`
- `test_grounding_context.py`: `10`
- `test_health.py`: `3`
...
- Total script tests discovered: `77`
- `scripts/tests/test_compare_calibration_manifests.py`: `10`
- `scripts/tests/test_export_selected_proposal_markdown.py`: `4`
- `scripts/tests/test_proposal_gap_analysis.py`: `8`
- `scripts/tests/test_run_calibration_manifest_actions.py`: `23`
