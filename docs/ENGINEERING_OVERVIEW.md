...
- Total backend tests discovered: `141`
- `test_agents.py`: `27`
- `test_common_proposal_scenarios.py`: `8`
- `test_drafting_blueprint.py`: `3`
- `test_export.py`: `10`
- `test_export_readiness_report.py`: `2`
- `test_files.py`: `10`
- `test_generation_jobs.py`: `6`
- `test_grounding_context.py`: `4`
- `test_health.py`: `3`
...
- `test_requirement_coverage_strictness.py`: `2`
...
- Total script tests discovered: `10`
- `scripts/tests/test_export_selected_proposal_markdown.py`: `3`
- `scripts/tests/test_proposal_gap_analysis.py`: `3`
- `scripts/tests/test_run_proposal_calibration.py`: `4`
