...
- `services/api/app/legislation/`
  - `services/api/app/legislation/__init__.py`
  - `services/api/app/legislation/lex_bg.py`
...
- Total backend tests discovered: `163`
- `test_agents.py`: `36`
- `test_common_proposal_scenarios.py`: `11`
- `test_drafting_blueprint.py`: `3`
- `test_export.py`: `11`
- `test_export_readiness_report.py`: `2`
- `test_files.py`: `10`
- `test_generation_jobs.py`: `8`
- `test_grounding_context.py`: `8`
- `test_health.py`: `3`
...
- `test_parsers.py`: `4`
- `test_projects.py`: `15`
- `test_proposal_quality.py`: `10`
- `test_requirement_checklist.py`: `11`
- `test_requirement_coverage.py`: `2`
- `test_requirement_coverage_strictness.py`: `3`
...
- Total script tests discovered: `62`
- `scripts/tests/test_compare_calibration_manifests.py`: `7`
- `scripts/tests/test_export_selected_proposal_markdown.py`: `4`
- `scripts/tests/test_proposal_gap_analysis.py`: `8`
- `scripts/tests/test_run_calibration_manifest_actions.py`: `16`
- `scripts/tests/test_run_calibration_remediation_cycle.py`: `12`
- `scripts/tests/test_run_proposal_calibration.py`: `15`
